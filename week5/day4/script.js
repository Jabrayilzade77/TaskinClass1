...
// console.table(arr)
// arr.sort((a,b) => (a.urunAdi > b.urunAdi) ? 1 : ((b.urunAdi > a.urunAdi) ? -1 : 0))
// console.table(arr)
// arr.sort((a,b) => (a.urunAdi < b.urunAdi) ? 1 : ((b.urunAdi < a.urunAdi) ? -1 : 0))
// console.table(arr)
...
// const result = arr.reduce((yaddas,indiki) => indiki.unitsOnOrder * indiki.unitPrice + yaddas,0)
// console.log(result);
...
//     sayHi(){
//         console.log(`Salam men ${this.name} em`);
//     }
// }

// class Cat extends Animal{
//     constructor(name,age,reng){
//         super(name,age)
//         this.reng = reng
//     }
//     renginiDe(){
//         console.log(`${this.reng} rengdeyem`);
//     }
// }

// const obj = new Animal("Heyvanlar",20)
// console.log(obj);
// obj.sayHi()
// const pisik = new Cat("Max",2,"Qirmizi")
// console.log(pisik);
// pisik.sayHi()
// pisik.renginiDe()
